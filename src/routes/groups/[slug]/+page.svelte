<script>
    ...
    export let userIndex = group.Members.findIndex(member => member.uid === user.uid);
    export let userData = group.Members[userIndex];
    ...
    function formHandler() {
        return async ({ result, update }) => {
            if (result.type == "success") {
                userData.wishlist = result.data.Wishlist;
                hideEditWishlistForm = true;
            }
        };
    }
</script>
    ...
    <div class="PageSection">
        <div class="PageSectionInner">
            ...
            {:else}
                ...
                <form id="UpdateWishlistForm" method="post" action="?/UpdateWishlist" class="EditWishlistForm" autocomplete="off" use:enhance={formHandler}>
                        ...
                        <li class="GroupMember">
                            ...
                            <div class="GroupMemberInfo">
                                ...
                                {#if Member.uid == user.uid}
                                    {#if isLink(userData.wishlist)}
                                        <a rel="external" class="WishlistLink" href={userData.wishlist}>View Wishlist →</a>
                                    {:else}
