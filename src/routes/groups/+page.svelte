        ...
        <div class="PageSection">
            <div class="PageSectionInner">
                <div class="CurrentUser">
                    <img class="CurrentUserImage" src="{user.photoURL}" alt="Your Profile Pic" referrerpolicy="no-referrer" />
                    <div class="CurrentUserText">
                        <h3>{user.displayName}</h3>
                        <p>{yourGroups.length} groups</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <a href="/groups/{Group.id}" class="GroupListItem">
                                <div class="GroupListItemLeft">
                                    ...
                                    <div class="GroupListItemRow">
                                        <span class="GroupStatus {Group.MatchesGenerated ? "Ended" : Group.SecretCode == "" ? "Open" : "Private"}">
                                            {Group.MatchesGenerated ? "Ended" : Group.SecretCode == "" ? "Open" : "Private"}
                                        </span>    
...
<style>
    ...
    .GroupStatus.Ended {
        background-color: rgb(131, 154, 166);
    }
